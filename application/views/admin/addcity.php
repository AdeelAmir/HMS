...
<head>
    ...
    <title>Admin - Dashboard | Add City</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
					            ...
					            <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control req-field" placeholder="City Name" name="_dept" id="_dept" value="" />
                                </div>
...
<script>
    ...
    function Add(){
        if(formValidator("#addDepartment") === 0){
            ...
            let title = $("#_dept").val();
            $.ajax({
                url:'<?php echo base_url() . 'City/AddCity' ?>',
                method: 'post',
                data: { '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>', Title : title},
