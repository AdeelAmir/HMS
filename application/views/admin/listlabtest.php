...
<head>
    ...
    <title>Admin - Dashboard | Lab Test List</title>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12 mt-3">
                    <button type="button" class="btn btn-outline-success float-right" onclick="window.location.href='<?= base_url('LabTest/NewLabTest'); ?>'"><i class="fa fa-plus" aria-hidden="true"></i> Add Lab Test</button>
                </div>
                <div class="col-md-12 text-center">
                    <div class="table-responsive">
                    <table class="table" id="LabTestList">
...
<script>
    let LabtestTable = null;
    $(document).ready(function () {
        if(LabtestTable !== null){
            LabtestTable.destroy();
        }
        LabtestTable = $("#LabTestList").DataTable({
            "processing": true,
            "serverSide": true,
            "paging": true,
            "bPaginate": true,
            ...
            "deferRender": true,
            ajax: {
                "url": "<?php echo site_url("LabTest/LabTestList") ?>",
                "type": "POST",
        ...
        $("#LabTestList_filter").css('display', 'none');
        //Left align 'showing entries' line
        $("#LabTestList_info").css('text-align', 'left').css('padding-top', '0.425em');
        //Leveling pagination buttons
        $("#LabTestList_length").css('text-align', 'left');
    });
    ...
    function Edit(id) {
        ...
        form.setAttribute("action", "<?= base_url('LabTest/EditLabTest'); ?>");
    ...
    function Delete(id) {
        ...
        $.ajax({
            url:'<?php echo base_url() . 'LabTest/DeleteLabtest' ?>',
            method: 'post',
