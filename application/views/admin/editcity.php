...
<head>
    ...
    <title>Admin - Dashboard | Edit City</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
					            ...
					            <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control req-field" placeholder="City Name" name="_dept" id="_dept" value="<?= $title; ?>" />
                                </div>
                            </div>
...
<script>
    function Edit(){
        if(formValidator("#editDepartment") === 0){
            ...
            let title = $("#_dept").val();
            $.ajax({
                url:'<?php echo base_url() . 'City/EditCity2' ?>',
                method: 'post',
                data: { '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>', Id : '<?= $id; ?>', Title : title},
