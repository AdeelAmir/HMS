        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12 mt-3">
                    <button type="button" class="btn btn-outline-success float-right" onclick="window.location.href='<?= base_url('Doctor/NewDoctor'); ?>'"><i class="fa fa-plus" aria-hidden="true"></i> Add Doctor</button>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        DoctorTable = $("#doctorList").DataTable({
            ...
            "deferRender": true,
            ajax: {
                "url": "<?php echo site_url("Doctor/DoctorList") ?>",
                "type": "POST",
    ...
    function Edit(id) {
        ...
        form.setAttribute("action", "<?= base_url('Doctor/EditDoctor'); ?>");
    ...
    function Delete(id) {
        ...
        $.ajax({
            url:'<?php echo base_url() . 'Doctor/DeleteDoctor' ?>',
            method: 'post',
