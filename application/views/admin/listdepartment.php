        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12 mt-3">
                    <button type="button" class="btn btn-outline-success float-right" onclick="window.location.href='<?= base_url('Category/NewCategory'); ?>'"><i class="fa fa-plus" aria-hidden="true"></i> Add Category</button>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        DepartmentTable = $("#departmentList").DataTable({
            ...
            "deferRender": true,
            ajax: {
                "url": "<?php echo site_url("Category/CategoryList") ?>",
                "type": "POST",
