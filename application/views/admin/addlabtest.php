...
<head>
    ...
    <title>Admin - Dashboard | Add Lab Test</title>
        ...
        <div class="container-fluid">
            ...
            <div class="row" style="margin-top: 10vh;">
                ...
                <div class="col-xs-12 col-md-6">
                    <form action="#" id="addLabTest" method="post">
                        <div class="row">
                            <div class="col-md-12">
					            ...
					            <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control req-field" placeholder="Test" name="_test" id="_test" value="" />
                                </div>
                            </div>
                            <div class="col-md-12">
					            ...
					            <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control req-field" placeholder="Rate" name="_rate" id="_rate" value="" />
                                </div>
                            </div>
                            <div class="col-md-12">
					            ...
					            <div class="input-group mb-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="file" accept=".doc, .docx" class="form-control req-field" name="_file" id="_file" />
                                    </div>
                                </div>
                            </div>
...
<script>
    function Add(){
        if(formValidator("#addLabTest") === 0){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('LabTest/AddLabTest'); ?>",
                processData: false,
                contentType: false,
                dataType : 'script',
                data: formData
