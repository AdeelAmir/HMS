...
<head>
    ...
    <title>Admin - Dashboard | Edit Doctor</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
					            ...
					            <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control req-field" placeholder="Doctor Name" name="_name" id="_name" value="<?= $name; ?>" />
                                </div>
                            </div>
                            <div class="col-md-12">
					            ...
					            <div class="input-group mb-3">
                                    ...
                                    <input type="email" class="form-control req-field" placeholder="Email" name="_email" id="_email" value="<?= $email; ?>" />
                                </div>
                            ...
                            <div class="col-md-12">
					            ...
					            <div class="input-group mb-3">
                                    ...
                                    <input type="password" class="form-control" placeholder="*******" name="_pass" id="_pass" value="" />
                                </div>
                            </div>
                            <div class="col-md-12">
					            ...
					            <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control req-field" placeholder="Address" name="_address" id="_address" value="<?= $address; ?>" />
                                </div>
                            </div>
                            <div class="col-md-12">
					            ...
					            <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control req-field" placeholder="Phone" name="_phone" id="_phone" value="<?= $phone; ?>" />
                                </div>
                            </div>
                            <div class="col-md-12">
					            ...
					            <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control req-field" placeholder="Profile" name="_profile" id="_profile" value="<?= $profile; ?>" />
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php
                                    if($picture != ""){
                                ?>
                                        <img id="uploadImage" src="<?= assets_url('assets/img/doctor/'. $picture); ?>" width="150" height="150" />
                                <?php    
                                }
                                    else{
                                ?>
					            ...
					            <div class="input-group mb-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="file" accept="image/gif, image/jpeg, image/png" class="form-control" name="_pic" id="_pic" onchange="readURL(this);" />
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function Edit(){
        if(formValidator("#addDoctor") === 0){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('Doctor/EditDoctor2'); ?>",
                processData: false,
                contentType: false,
                dataType : 'script',
                data: formData
